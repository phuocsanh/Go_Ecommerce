...
CREATE TABLE `go_crm_user` (
  ...
  `user_phone` varchar(20) NOT NULL COMMENT 'Phone Number',
  `user_username` varchar(100) NOT NULL COMMENT 'Username',
  ...
  `user_create_ip_at` varchar(45) NOT NULL COMMENT 'Creation IP',
  `user_last_login_at` int NOT NULL COMMENT 'Last Login Time',
  `user_last_login_ip_at` varchar(45) NOT NULL COMMENT 'Last Login IP',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table for go_crm_user';
...
-- Dump completed on 2024-10-25  3:42:01
